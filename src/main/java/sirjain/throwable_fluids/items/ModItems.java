...
public class ModItems {
    ...
    public static void registerModItems() {
        THROWABLE_WATER = Registry.register(
                ...
                new ThrowableWaterItem(new Item.Settings().group(ThrowableFluids.TF_ITEM_GROUP).maxCount(32))
        );
    ...
    public static void registerMobSpawnEggItems() {
        SPLASHER_SPAWN_EGG = Registry.register(
                ...
                new SpawnEggItem(ModEntityTypes.SPLASHER_ENTITY, 0xaa9cff, 0xdcac55, new Item.Settings().group(ThrowableFluids.TF_ITEM_GROUP))
        );

        GLOW_WORM_SPAWN_EGG = Registry.register(
                Registry.ITEM,
                new Identifier(ThrowableFluids.MOD_ID, "glow_worm_spawn_egg"),
                new SpawnEggItem(ModEntityTypes.GLOW_WORM_ENTITY, 0xa73b3f, 0xff7c1b, new Item.Settings().group(ThrowableFluids.TF_ITEM_GROUP))
        );
    }
}